...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='CourseIndexPageRelatedLink',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('br_link', models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='wagtailcore.Page', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(related_name='related_links', to='demo.CoursePage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.AddField(
            model_name='courseindexpagerelatedlink',
            name='link_page',
        ...
        migrations.AddField(
            model_name='courseindexpagerelatedlink',
            name='page',
            field=modelcluster.fields.ParentalKey(related_name='related_links', to='demo.CourseIndexPage'),
            preserve_default=True,
        ),
        migrations.AddField(
